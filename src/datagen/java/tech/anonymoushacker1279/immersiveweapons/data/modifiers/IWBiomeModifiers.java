...
public class IWBiomeModifiers {
	...
	public static void bootstrap(BootstrapContext<BiomeModifier> context) {
		// Ores
		biomeModifier(context, Identifier.fromNamespaceAndPath(ImmersiveWeapons.MOD_ID, "molten_ore"),
		...
		biomeModifier(context, Identifier.fromNamespaceAndPath(ImmersiveWeapons.MOD_ID, "cobalt_ore"),
				new BiomeModifiers.AddFeaturesBiomeModifier(
						context.lookup(Registries.BIOME).getOrThrow(BiomeTags.IS_OVERWORLD),
		...
		biomeModifier(context, Identifier.fromNamespaceAndPath(ImmersiveWeapons.MOD_ID, "void_ore"),
				new BiomeModifiers.AddFeaturesBiomeModifier(
	...
	protected static void biomeModifier(BootstrapContext<BiomeModifier> context, Identifier name, BiomeModifier modifier) {
