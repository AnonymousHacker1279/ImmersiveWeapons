...
public class IronBulletItem extends AbstractArrowItem {
	 ...
	 */
	@Override
	public @NotNull IronBulletEntity createArrow(@NotNull Level level, @NotNull ItemStack stack, @NotNull LivingEntity shooter) {
		IronBulletEntity bulletEntity = new IronBulletEntity(shooter, level, ref.get().asItem());
