...
import com.anonymoushacker1279.immersiveweapons.entity.projectile.BulletEntities.NetheriteBulletEntity;
...
public class NetheriteBulletItem extends AbstractBulletItem {
	 ...
	 */
	@Override
	public @NotNull NetheriteBulletEntity createBullet(@NotNull Level level, @NotNull ItemStack stack, @NotNull LivingEntity shooter) {
		NetheriteBulletEntity bulletEntity = new NetheriteBulletEntity(shooter, level, referenceItem.get().asItem());
