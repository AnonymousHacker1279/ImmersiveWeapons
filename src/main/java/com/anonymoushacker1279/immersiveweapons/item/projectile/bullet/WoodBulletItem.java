...
import com.anonymoushacker1279.immersiveweapons.entity.projectile.BulletEntities.WoodBulletEntity;
...
public class WoodBulletItem extends AbstractBulletItem {
	 ...
	 */
	@Override
	public @NotNull WoodBulletEntity createBullet(@NotNull Level level, @NotNull ItemStack stack, @NotNull LivingEntity shooter) {
		WoodBulletEntity bulletEntity = new WoodBulletEntity(shooter, level, referenceItem.get().asItem());
