...
public class CloudIslandPieces {
	...
	public static void start(StructureManager structureManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList) {
		...
		pieceList.add(new CloudIslandPieces.Piece(structureManager, CENTER, blockPos, rotation));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		Piece(StructureManager structureManager, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
			super(Structures.CI, 0, structureManager, resourceLocationIn, resourceLocationIn.toString(), makeSettings(rotationIn, resourceLocationIn), makePosition(resourceLocationIn, pos));
		}
		...
		private static BlockPos makePosition(ResourceLocation resourceLocation, BlockPos blockPos) {
			return blockPos.offset(CloudIslandPieces.OFFSET.get(resourceLocation));
		}
