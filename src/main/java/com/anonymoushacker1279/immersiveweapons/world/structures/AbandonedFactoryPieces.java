...
public class AbandonedFactoryPieces {
	...
	public static void start(StructureManager structureManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList) {
		...
		pieceList.add(new AbandonedFactoryPieces.Piece(structureManager, blockPos, rotation));
	}
	...
	public static class Piece extends TemplateStructurePiece {
		...
		Piece(StructureManager structureManager, BlockPos pos, Rotation rotationIn) {
			super(Structures.AF, 0, structureManager, AbandonedFactoryPieces.CENTER, AbandonedFactoryPieces.CENTER.toString(), makeSettings(rotationIn, AbandonedFactoryPieces.CENTER), makePosition(pos));
		}
		...
		public Piece(ServerLevel level, CompoundTag tag) {
			super(Structures.AF, tag, level, (resourceLocation) -> makeSettings(Rotation.valueOf(tag.getString("Rot")), resourceLocation));
		}
		...
		private static BlockPos makePosition(BlockPos blockPos) {
			return blockPos.offset(AbandonedFactoryPieces.OFFSET.get(AbandonedFactoryPieces.CENTER));
		}
