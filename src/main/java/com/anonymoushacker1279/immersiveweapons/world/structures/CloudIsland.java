...
public class CloudIsland extends Structure<NoFeatureConfig> {

	public CloudIsland(Codec<NoFeatureConfig> codec) {
		super(codec);
	}
	...
	public static class Start extends StructureStart<NoFeatureConfig> {
		...
		public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
			...
			CloudIslandPieces.start(templateManagerIn, blockpos, rotation, this.pieces, this.random);
