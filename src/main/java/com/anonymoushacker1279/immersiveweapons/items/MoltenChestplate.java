...
public class MoltenChestplate extends ArmorItem {

	public MoltenChestplate() {
		super(CustomArmorMaterials.MOLTEN, EquipmentSlotType.CHEST, (new Item.Properties().group(ImmersiveWeapons.TAB)));
	}
