...
public class SmokeBombParticle extends TextureSheetParticle {
	...
	public static class Provider implements ParticleProvider<SmokeBombParticleOptions> {
		...
		@Override
		public Particle createParticle(@NotNull SmokeBombParticleOptions pType, @NotNull ClientLevel pLevel, double pX, double pY, double pZ,
		                               double pXSpeed, double pYSpeed, double pZSpeed) {

			return new SmokeBombParticle(pLevel, pX, pY, pZ,
					pXSpeed, pYSpeed, pZSpeed, sprites, pType.getColor());
		}
	}

	protected SmokeBombParticle(ClientLevel level, double x, double y, double z,
