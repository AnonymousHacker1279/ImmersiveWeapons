...
public class ItemLists {
	...
	static {
		...
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.WOODEN_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.STONE_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.COPPER_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.IRON_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.COBALT_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.GOLDEN_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.DIAMOND_PIKE.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.NETHERITE_PIKE.get());
		...
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.WOODEN_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.STONE_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.GOLDEN_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.COPPER_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.IRON_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.COBALT_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.DIAMOND_GAUNTLET.get());
		MODEL_GENERATOR_IGNORED_ITEMS.add(ItemRegistry.NETHERITE_GAUNTLET.get());
