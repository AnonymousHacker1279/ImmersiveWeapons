		...
		out.accept(LootTableLocations.CHAMPION_TOWER_TIER_1,
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								...
								.add(LootItem.lootTableItem(ItemRegistry.DIAMOND_MUSKET_BALL.get()).setWeight(15)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.DIAMOND_ARROW.get()).setWeight(15)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
								.add(LootItem.lootTableItem(Items.DIAMOND_SWORD).setWeight(5)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(15.0F, 25.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_PICKAXE).setWeight(5)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(15.0F, 25.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_AXE).setWeight(5)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(15.0F, 25.0F)
										)))
								.add(LootItem.lootTableItem(ItemRegistry.TESLA_NUGGET.get()).setWeight(11)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.MOLTEN_SHARD.get()).setWeight(11)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.VENTUS_SHARD.get()).setWeight(11)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.STARSTORM_SHARD.get()).setWeight(11)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.ASTRAL_NUGGET.get()).setWeight(11)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F)))))
						.withPool(LootPool.lootPool()
								.name("healing")
		...
		out.accept(LootTableLocations.CHAMPION_TOWER_TIER_2,
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								.name("main")
								.setRolls(ConstantValue.exactly(2))
								.add(LootItem.lootTableItem(ItemRegistry.DIAMOND_MUSKET_BALL.get()).setWeight(18)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(6.0F, 14.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.DIAMOND_ARROW.get()).setWeight(18)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(6.0F, 14.0F))))
								.add(LootItem.lootTableItem(Items.NETHERITE_SWORD).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.NETHERITE_PICKAXE).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.NETHERITE_AXE).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.NETHERITE_SHOVEL).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.NETHERITE_HOE).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_HELMET).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_CHESTPLATE).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_LEGGINGS).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
								.add(LootItem.lootTableItem(Items.DIAMOND_BOOTS).setWeight(7)
										.apply(EnchantWithLevelsFunction.enchantWithLevels(
												UniformGenerator.between(25.0F, 35.0F)
										)))
