				...
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								...
								.add(LootItem.lootTableItem(ItemRegistry.ASTRAL_NUGGET.get()).setWeight(10)
										.apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
								.add(LootItem.lootTableItem(ItemRegistry.KILL_COUNTER.get()).setWeight(2)))
						.withPool(LootPool.lootPool()
								.name("healing")
		...
		out.accept(LootTableLocations.CHAMPION_TOWER_TIER_2,
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								...
								.add(LootItem.lootTableItem(ItemRegistry.HOLY_MANTLE.get()).setWeight(1))
								.add(LootItem.lootTableItem(ItemRegistry.DEATH_GEM_RING.get()).setWeight(1))
								.add(LootItem.lootTableItem(ItemRegistry.VENSTRAL_JAR.get()).setWeight(1)))
						.withPool(LootPool.lootPool()
								.name("healing")
								.setRolls(UniformGenerator.between(2.0F, 4.0F))
