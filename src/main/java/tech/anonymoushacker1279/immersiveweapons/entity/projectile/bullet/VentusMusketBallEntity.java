...
public class VentusMusketBallEntity extends BulletEntity implements HitEffectUtils {

	public VentusMusketBallEntity(EntityType<VentusMusketBallEntity> entityType, Level level, int knockbackStrength) {
		super(entityType, level);
		this.knockbackStrength = knockbackStrength;
	}

	public VentusMusketBallEntity(LivingEntity shooter, Level level) {
		super(EntityRegistry.VENTUS_MUSKET_BALL_ENTITY.get(), shooter, level);
	}
	...
	public @Nullable Item getReferenceItem() {
		return ItemRegistry.VENTUS_MUSKET_BALL.get();
	}
