...
public class SoundEventRegistry {
	...
	public static final RegistryObject<SoundEvent> STARLIGHT_PLAINS_AMBIENT = SOUND_EVENTS.register("starlight_plains_ambient", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starlight_plains_ambient")));
