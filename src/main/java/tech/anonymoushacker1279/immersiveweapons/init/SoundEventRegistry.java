...
public class SoundEventRegistry {
	...
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> TESLA_ARMOR_EQUIP = SOUND_EVENTS.register("tesla_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "tesla_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> MOLTEN_ARMOR_EQUIP = SOUND_EVENTS.register("molten_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "molten_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> VENTUS_ARMOR_EQUIP = SOUND_EVENTS.register("ventus_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "ventus_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> COPPER_ARMOR_EQUIP = SOUND_EVENTS.register("copper_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "copper_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> COBALT_ARMOR_EQUIP = SOUND_EVENTS.register("cobalt_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "cobalt_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> ASTRAL_ARMOR_EQUIP = SOUND_EVENTS.register("astral_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "astral_armor_equip")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> STARSTORM_ARMOR_EQUIP = SOUND_EVENTS.register("starstorm_armor_equip", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starstorm_armor_equip")));
	...
	public static final Supplier<SoundEvent> FLASHBANG_EXPLODE = SOUND_EVENTS.register("flashbang_explode", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "flashbang_explode")));
	public static final Supplier<SoundEvent> FLASHBANG_RINGING = SOUND_EVENTS.register("flashbang_ringing", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "flashbang_ringing")));
	...
	public static final Supplier<SoundEvent> SOLDIER_AMBIENT = SOUND_EVENTS.register("soldier_ambient", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "soldier_ambient")));
	public static final Supplier<SoundEvent> SOLDIER_STEP = SOUND_EVENTS.register("soldier_step", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "soldier_step")));
	public static final Supplier<SoundEvent> SOLDIER_DEATH = SOUND_EVENTS.register("soldier_death", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "soldier_death")));
	public static final Supplier<SoundEvent> SOLDIER_HURT = SOUND_EVENTS.register("soldier_hurt", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "soldier_hurt")));
	...
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> STARLIGHT_PLAINS_BACKGROUND_MUSIC = SOUND_EVENTS.register("starlight_plains_background_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starlight_plains_background_music")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> STARLIGHT_PLAINS_THEME_1 = SOUND_EVENTS.register("starlight_plains_theme_1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starlight_plains_theme_1")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> STARLIGHT_PLAINS_THEME_2 = SOUND_EVENTS.register("starlight_plains_theme_2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starlight_plains_theme_2")));
	...
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> DEADMANS_DESERT_BACKGROUND_MUSIC = SOUND_EVENTS.register("deadmans_desert_background_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "deadmans_desert_background_music")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> DEADMANS_DESERT_THEME_1 = SOUND_EVENTS.register("deadmans_desert_theme_1", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "deadmans_desert_theme_1")));
	public static final DeferredHolder<SoundEvent, ? extends SoundEvent> DEADMANS_DESERT_THEME_2 = SOUND_EVENTS.register("deadmans_desert_theme_2", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "deadmans_desert_theme_2")));
