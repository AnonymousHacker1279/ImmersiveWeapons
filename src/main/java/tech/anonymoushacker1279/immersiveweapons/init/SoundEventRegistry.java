...
public class SoundEventRegistry {
	...
	public static final RegistryObject<SoundEvent> GENERIC_ITEM_THROW = SOUND_EVENTS.register("generic_whoosh", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "generic_whoosh")));
	...
	public static final RegistryObject<SoundEvent> STARLIGHT_PLAINS_MUSIC = SOUND_EVENTS.register("starlight_plains_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "starlight_plains_music")));
	public static final RegistryObject<SoundEvent> TILTROS_WASTES_MUSIC = SOUND_EVENTS.register("tiltros_wastes_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "tiltros_wastes_music")));
	public static final RegistryObject<SoundEvent> DEADMANS_DESERT_MUSIC = SOUND_EVENTS.register("deadmans_desert_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "deadmans_desert_music")));
