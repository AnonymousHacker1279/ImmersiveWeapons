...
public class SoundEventRegistry {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> STARLIGHT_PLAINS_MOOD = register("starlight_plains_mood");
	public static final DeferredHolder<SoundEvent, SoundEvent> STARLIGHT_PLAINS_AMBIENT = register("starlight_plains_ambient");
	public static final DeferredHolder<SoundEvent, SoundEvent> STARLIGHT_PLAINS_AMBIENT_ADDITIONS = register("starlight_plains_ambient_additions");
	public static final DeferredHolder<SoundEvent, SoundEvent> TILTROS_WASTES_MUSIC = register("tiltros_wastes_music");
	public static final DeferredHolder<SoundEvent, SoundEvent> TILTROS_WASTES_MOOD = register("tiltros_wastes_mood");
	public static final DeferredHolder<SoundEvent, SoundEvent> TILTROS_WASTES_AMBIENT = register("tiltros_wastes_ambient");
	public static final DeferredHolder<SoundEvent, SoundEvent> TILTROS_WASTES_AMBIENT_ADDITIONS = register("tiltros_wastes_additions");
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> DEADMANS_DESERT_MOOD = register("deadmans_desert_mood");
	public static final DeferredHolder<SoundEvent, SoundEvent> DEADMANS_DESERT_AMBIENT = register("deadmans_desert_ambient");
	public static final DeferredHolder<SoundEvent, SoundEvent> DEADMANS_DESERT_AMBIENT_ADDITIONS = register("deadmans_desert_ambient_additions");
