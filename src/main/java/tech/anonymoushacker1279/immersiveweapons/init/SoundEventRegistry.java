...
public class SoundEventRegistry {
	...
	public static final RegistryObject<SoundEvent> TILTROS_MUSIC = SOUND_EVENTS.register("tiltros_music", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ImmersiveWeapons.MOD_ID, "tiltros_music")));
