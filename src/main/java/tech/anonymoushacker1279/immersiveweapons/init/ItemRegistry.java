...
public class ItemRegistry {
	...
	public static final RegistryObject<MoltenMusketBallItem> MOLTEN_MUSKET_BALL = ITEMS.register("molten_musket_ball", () -> new MoltenMusketBallItem(new Properties().fireResistant(), 7.50d));
	public static final RegistryObject<TeslaMusketBallItem> TESLA_MUSKET_BALL = ITEMS.register("tesla_musket_ball", () -> new TeslaMusketBallItem(new Properties(), 8.0d));
	public static final RegistryObject<VentusMusketBallItem> VENTUS_MUSKET_BALL = ITEMS.register("ventus_musket_ball", () -> new VentusMusketBallItem(new Properties(), 7.50d));
