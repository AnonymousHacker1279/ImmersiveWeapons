...
public class BlockRegistry {
	...
	public static final RegistryObject<AstralCrystalBlock> ASTRAL_CRYSTAL = BLOCKS.register("astral_crystal", () -> new AstralCrystalBlock(7, 3, BlockBehaviour.Properties.of(Material.AMETHYST).randomTicks().strength(0.4f).sound(SoundType.AMETHYST_CLUSTER).requiresCorrectToolForDrops().lightLevel((blockState) -> 6)));
	...
	public static final RegistryObject<Block> RUSTED_IRON_BLOCK = BLOCKS.register("rusted_iron_block", () -> new Block(BlockBehaviour.Properties.of(Material.METAL).sound(SoundType.METAL).strength(4.0f, 5.0f).requiresCorrectToolForDrops()));
	// Iron tier
	...
	public static final RegistryObject<DoorBlock> BURNED_OAK_DOOR = BLOCKS.register("burned_oak_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(1.7f, 2.7f).sound(SoundType.WOOD), CustomBlockSetTypes.BURNED_OAK));
	public static final RegistryObject<TrapDoorBlock> BURNED_OAK_TRAPDOOR = BLOCKS.register("burned_oak_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(1.7f, 2.7f).sound(SoundType.WOOD).noOcclusion(), CustomBlockSetTypes.BURNED_OAK));
	public static final RegistryObject<PressurePlateBlock> BURNED_OAK_PRESSURE_PLATE = BLOCKS.register("burned_oak_pressure_plate", () -> new PressurePlateBlock(Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD).strength(0.4f).sound(SoundType.WOOD).noOcclusion().noCollission(), CustomBlockSetTypes.BURNED_OAK));
	...
	public static final RegistryObject<ButtonBlock> BURNED_OAK_BUTTON = BLOCKS.register("burned_oak_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.4f).sound(SoundType.WOOD), CustomBlockSetTypes.BURNED_OAK, 30, true));
	...
	public static final RegistryObject<DoorBlock> STARDUST_DOOR = BLOCKS.register("stardust_door", () -> new DoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.3f).sound(SoundType.WOOD), CustomBlockSetTypes.STARDUST));
	public static final RegistryObject<TrapDoorBlock> STARDUST_TRAPDOOR = BLOCKS.register("stardust_trapdoor", () -> new TrapDoorBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.3f).sound(SoundType.WOOD).noOcclusion(), CustomBlockSetTypes.STARDUST));
	public static final RegistryObject<PressurePlateBlock> STARDUST_PRESSURE_PLATE = BLOCKS.register("stardust_pressure_plate", () -> new PressurePlateBlock(Sensitivity.EVERYTHING, BlockBehaviour.Properties.of(Material.WOOD).strength(0.7f).sound(SoundType.WOOD).noOcclusion().noCollission(), CustomBlockSetTypes.STARDUST));
	public static final RegistryObject<ButtonBlock> STARDUST_BUTTON = BLOCKS.register("stardust_button", () -> new ButtonBlock(BlockBehaviour.Properties.of(Material.WOOD).noCollission().strength(0.7f).sound(SoundType.WOOD), CustomBlockSetTypes.STARDUST, 30, true));
