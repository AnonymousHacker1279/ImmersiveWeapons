...
public class AccessoryEffectTypeRegistry {
	...
	/// Modifier to melee critical damage. Additive with vanilla critical damage, which is 50% by default. For example,
	/// a value of 0.5d will result in 100% critical damage.
