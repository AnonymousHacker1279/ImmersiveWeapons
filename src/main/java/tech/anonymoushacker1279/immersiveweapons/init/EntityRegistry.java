...
public class EntityRegistry {
	...
	public static final Supplier<EntityType<DyingSoldierEntity>> DYING_SOLDIER_ENTITY = register("dying_soldier", EntityType.Builder.of(DyingSoldierEntity::new, MobCategory.MONSTER).sized(0.6f, 1.99f).clientTrackingRange(8).notInPeaceful());
	public static final Supplier<EntityType<TheCommanderEntity>> THE_COMMANDER_ENTITY = register("the_commander", EntityType.Builder.of(TheCommanderEntity::new, MobCategory.MONSTER).sized(0.6f, 1.99f).clientTrackingRange(8).notInPeaceful());
	...
	public static final Supplier<EntityType<WanderingWarriorEntity>> WANDERING_WARRIOR_ENTITY = register("wandering_warrior", EntityType.Builder.of(WanderingWarriorEntity::new, MobCategory.MONSTER).sized(0.6f, 1.99f).clientTrackingRange(16).notInPeaceful());
	@LanguageEntryOverride("Hans the Almighty")
	public static final Supplier<EntityType<HansEntity>> HANS_ENTITY = register("hans", EntityType.Builder.of(HansEntity::new, MobCategory.MONSTER).sized(0.6f, 1.99f).clientTrackingRange(16).notInPeaceful());
	@LanguageEntryOverride("Super Hans the Almighty")
	public static final Supplier<EntityType<SuperHansEntity>> SUPER_HANS_ENTITY = register("super_hans", EntityType.Builder.of(SuperHansEntity::new, MobCategory.MONSTER).sized(1.2f, 3.98f).clientTrackingRange(16).notInPeaceful());
	...
	public static final Supplier<EntityType<LavaRevenantEntity>> LAVA_REVENANT_ENTITY = register("lava_revenant", EntityType.Builder.of(LavaRevenantEntity::new, MobCategory.MONSTER).sized(0.25f, 0.25f).clientTrackingRange(16).fireImmune().notInPeaceful());
	public static final Supplier<EntityType<RockSpiderEntity>> ROCK_SPIDER_ENTITY = register("rock_spider", EntityType.Builder.of(RockSpiderEntity::new, MobCategory.MONSTER).sized(0.30f, 0.30f).clientTrackingRange(16).notInPeaceful());
	public static final Supplier<EntityType<CelestialTowerEntity>> CELESTIAL_TOWER_ENTITY = register("celestial_tower", EntityType.Builder.of(CelestialTowerEntity::new, MobCategory.MONSTER).sized(8.0f, 9.0f).clientTrackingRange(32).notInPeaceful());
