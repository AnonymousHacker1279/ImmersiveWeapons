...
public class MenuTypeRegistry {
	...
	public static final Supplier<MenuType<StarForgeMenu>> STAR_FORGE_MENU = MENU_TYPES.register("star_forge", () -> IMenuTypeExtension.create((id, inv, data) -> new StarForgeMenu(id, inv)));
}